            ...
            <div key={currentMatchId} className="p-2 space-x-4 flex flex-row items-center bg-green-800 text-black font-inter">
                <p>Match {currentMatchId}:</p>
                    ...
                    <div className="flex flex-col items-center space-y-4">
                        <input type="number" className='bg-yellow-200 focus:outline-none text-center placeholder:text-sm placeholder:text-black-700' placeholder={`Score for ${participant1.name}`} onChange={(e) => handleScoreChange(e, currentMatchId, 'participant1',i)} />
                        <input type="number" className='bg-yellow-200 focus:outline-none text-center placeholder:text-sm placeholder:text-black-700' placeholder={`Score for ${participant2.name}`} onChange={(e) => handleScoreChange(e, currentMatchId, 'participant2', i+1)} />
                    </div>
